...
@section('body')
    ...
    <div class="table-responsive">
        ...
        <h3 style="margin-top: 20px">Current Image</h3>
        <div><img src="{{asset ('storage')}}/product_images/{{$product['image']}}" alt="pic" width="100" height="100" style="max-height: 220px"></div>
